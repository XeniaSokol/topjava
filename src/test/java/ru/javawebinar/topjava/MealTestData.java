...
public class MealTestData {
    ...
    public static final Meal ADMIN_MEAL1 = new Meal(MEAL_ADMIN_ID, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 500);
    public static final Meal ADMIN_MEAL2 = new Meal(MEAL_ADMIN_ID + 1, LocalDateTime.of(2020, Month.JANUARY, 31, 21, 0), "Админ ужин", 1500);

    public static final List<Meal> MEALS = Arrays.asList(MEAL7, MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1);

    public static Meal getNew() {
        return new Meal(null, LocalDateTime.of(2023, Month.JANUARY, 31, 13, 0), "new Dinner", 1000);
    }

    public static Meal getUpdated() {
        return new Meal(MEAL_ID, MEAL1.getDateTime().plus(2, ChronoUnit.MINUTES), "Обновление завтрака", 500);
    }
